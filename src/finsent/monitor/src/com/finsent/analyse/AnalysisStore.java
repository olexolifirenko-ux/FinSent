...
public final class AnalysisStore
{
    ...
    /** Merge a standalone macro-alert into the window's interval and commit it atomically. */
    public void recordMacroAlert(String day, String intervalKey, ObjectNode macroAlert)
    {
